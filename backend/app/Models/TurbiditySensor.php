...
class TurbiditySensor extends Model
{
    use HasFactory;
    ...
    /**
     * Get the latest turbidity reading for a specific sensor
     */
    ...
    /**
     * Get turbidity readings for a specific sensor within a time range
     */
